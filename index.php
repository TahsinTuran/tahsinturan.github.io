...
<head>
    ...
    <title>CVV CHECKER By Rakhilukky</title>
    <!-- CSS -->
...
<body style="background-co: blue;" class="content-dark">
        <!-- /.site-sidebar -->
        <main class="main-wrapper clearfix">
            <!-- Page Title Area -->
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5"><strong>By Rakhilukky coder</strong></h6>
                ...
                <div class="widget-holder widget-full-height widget-flex col-lg-6">
                    <div class="widget-bg">
                        <div class="widget-heading">
                            <h5 class="widget-title"> Team Approdia </h5>
                        ...
                        <div class="widget-body">
                            <button type="button" id="sh_apr" onclick="Mudaestado('aprovadasapp');" class="btn btn-success" style="background-image: linear-gradient(45deg, #9000ff, #0069d4);border-color: #ffffff;">APPROVED Cvv [ <span id="aprovada_conta">0</span> ]</button>
                        ...
                        <div class="widget-body">
                            <div class="container-fluid pd-20">
                                <div class="row">
                                    ...
                                    <p>Edited By :  <a target="_BLANK" href="https://telegram.me/rakhilukkycoder/">
                                    By Rakhilukky coder</a></p>
